...
import { IncidentsI } from './incident/services/incidentInterface';
import { IncidentServService } from './incident/services/incident-serv.service';
...
export class IncidentsComponent implements OnInit {
  ...
  displayedColumns: string[] = ['no','date', 'description', 'email','image','libelle', 'lieu','type', 'statut'];
  dataSource = new MatTableDataSource<IncidentsI>(this.incident)
